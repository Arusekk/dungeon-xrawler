// Copyright (C) 2005  by Piotr Hełka (piotr.helka@nd.e-wro.pl)
...
// Biblioteka obsługuje mniej lub bardziej zgodnie:
//
// cgets()
// cputs()
// clreol()
...
// window()
//
// kompatbyilność w kierunku Linux CONIO.H -> DOS CONIO.H
// bedzie zachowana
